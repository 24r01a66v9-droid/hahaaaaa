    ...
    <section id="careers" className="py-32 px-6 bg-[#fffcfc] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="mb-24">
          <a
            href="/"
            className="inline-flex items-center gap-2 text-[10px] font-bold uppercase tracking-[0.3em] text-brand-maroon/60 hover:text-brand-maroon transition-colors mb-8"
          >
